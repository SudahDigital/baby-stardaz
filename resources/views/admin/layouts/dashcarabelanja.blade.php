       ...
       <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            ...
            <a class="btn btn-success btn-sm" href="{{URL::route('form_carabelanja')}}">
              <i class="fas fa-plus">
              </i>
              Tambah
           </a>
          ...
          <table class="table">
              ...
              <tbody>
                  <tr>
                      ...
                      <td>
                          <a>
                            Proses bisa kamu lanjutkan dengan mengisi data pemesan, penerima, dan pengiriman.
                            Lalu kamu konfirmasikan daftar ini di halaman Konfirmasi Pemesanan sebelum kamu
                            mengirimkan kepada admin Imaji Shop.
                          </a>
                      </td>
